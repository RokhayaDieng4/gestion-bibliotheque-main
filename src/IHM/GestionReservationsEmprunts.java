...
public class GestionReservationsEmprunts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gestion des Emprunts et Réservations");

        jPanel5.setBackground(new java.awt.Color(255, 255, 255));
        jPanel5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        empruntsButton.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        empruntsButton.setForeground(new java.awt.Color(153, 0, 0));
        ...
        ReservationButton.setForeground(new java.awt.Color(153, 0, 51));
        ...
        retourButton.setForeground(new java.awt.Color(153, 0, 0));
        ...
        ReservationPanel.setBackground(new java.awt.Color(0, 153, 153));
        ReservationPanel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        menuResaPanel.setBackground(new java.awt.Color(0, 153, 153));
        ...
        affResaButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/aff.jpg"))); // NOI18N
        ...
        try {
            ...
            if (!identitfiant.equals("Choix ID")) {
                ...
                if (null != listEmprunts) {
                    ...
                    String titre[] = new String[]{"ID", "Exemplaire", "Abonné",
                        "Date Emprunt", "Date Retour"};
  ...
  int numreser=00;
    ...
    String formattedDate = myDateObj.format(myFormatObj);  
      ...
      private void fillResaJtable(ArrayList<Reservation> listReservations) {
        String titre[] = new String[]{"ID", "Oeuvre", "Abonné","Date Réservation"};
